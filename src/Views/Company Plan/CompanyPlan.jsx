...
const CompanyPlan = () => {
  ...
  const fetchData = async () => {
    const data = await GetCompanyPlan();
    setPlanList(data);
    ...
    <div className="App-container">
      ...
      <div className="App-Content-container">
        ...
        <div className="App-Content-Main">
          <div className="CompanyPlan-container">
                    ...
                    <div className="CardList-container">
                      {filteredPlanList.map((plan, index) => {
                        ...
                        const isDateMatched =
                          !selectedDate ||
                          (selectedDate >=
                            new Date(plan.start.seconds * 1000) &&
                            ...
                            >
                              ...
                              >
                                ...
                                <Row style={{ padding: "1vh 0 1.5vh 0" }}>
                                  ...
                                  <Col span={8}>
                                    <h4>
                                      {convertTimestampToDate(plan.start)}
                                    </h4>
                                  </Col>
                                ...
                                <Table
                                  ...
                                  dataSource={plan.planDetails.map(
                                    (detail, index) => ({
                                      ...detail,
                                      index: index + 1,
                                    })
