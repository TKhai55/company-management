...
import { DeletePlanData } from "../../Controls/PlanManagement";
import { AuthContext } from "../components/Context/AuthProvider";
import { useState } from "react";
import moment from "moment";
import DeleteModal from "../components/Modals/ModalDelete";
import { useNavigate } from "react-router-dom";
import { GetPlan } from "../../Controls/DepartmentPlanController";

const ManageDepartmentPlan = () => {
  ...
  const fetchData = async () => {
    const data = await GetPlan(department);
    setPlanList(data);
  };
  useEffect(() => {
    fetchData();
  ...
  return (
    <div>
      {sortedPlanList.length > 0 ? (
        <div className="ManageDepartmentPlan-container">
...
export default ManageDepartmentPlan;
