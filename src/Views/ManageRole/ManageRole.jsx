...
import { GetFunctionData ,AddMnRoleData, DeleteMnRoleData, EditMnRoleData }  from '../../Controls/ManageRoleController'
import CreateRoleController from '../../Controls/CreateRoleController'
import { Table, Space,Form, Button, InputNumber, Input, message, Select} from 'antd'
...
function ManageRole() {
    const columns = [
      {
        title: <span style={{ color: '#4ca3f5' , fontWeight: 'bold'}}>Role Name</span>,
        dataIndex: 'name',
        key: 'name',
        align: 'center',
      ...
      {
        title: <span style={{ color: '#4ca3f5', fontWeight: 'bold'}}>Function</span>,
        dataIndex: 'function',
        key: 'function',
        align: 'center',
      ...
      {
        title: <span style={{ color: '#4ca3f5' , fontWeight: 'bold'}}>Numerical Order</span>,
        dataIndex: 'stt',
        key: 'stt',
        align: 'center',
          ...
          <div className="ManageRole-container">
            <div className="role-create">
              ...
              <Form form={form} ref={formRef}>
                ...
                <Form.Item label="Function" name="function" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
                  <Select
                    ...
                    labelInValue
                    onChange={(value) => handleSelectChange('function', value.label)}
                  />
                </Form.Item>
                <Form.Item label="STT" name="stt" labelCol={{ span: 4 }}>
                  <InputNumber placeholder="STT" type="number" onChange={(value) => handleSelectChange('stt', value)} />
                </Form.Item>
              </Form>
              </CustomModal>
              <CustomModal
