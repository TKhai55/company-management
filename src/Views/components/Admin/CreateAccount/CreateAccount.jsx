  ...
  const steps = [
    {
      ...
      content: <Step1 onDataUpload={handleTableData} handleIsFileUploaded={setIsFileUploaded} />,
    },
    {
      title: 'Choose name column',
      content: <Step2 tableData={tableData} onPassNameIndex={setNameColumnIndex} />,
    },
    {
      title: 'Choose role column',
      content: <Step3 tableData={tableData} receivedNameIndex={nameColumnIndex} onPassRoleIndex={setRoleColumnIndex} />,
    },
    {
      title: 'Complete',
        ...
        <div className="App-Content-Main">
          <div style={{ margin: "30px 30px 0px 30px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              {current === steps.length - 1 && tableAccount.length === tableData.length && (
